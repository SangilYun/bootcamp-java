...
public abstract class Graph {
	...
	public static void main (String[] args) {
		...
		System.out.println("SimpleTest data:");
		GraphAdjList simpleTest = new GraphAdjList();
		GraphLoader.loadRoadMap("/Users/yunsangil/Documents/computing/JAVA/UCSDGraphs/data/testdata/simpletest.map", simpleTest);
