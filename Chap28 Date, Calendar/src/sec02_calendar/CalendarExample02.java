...
public class CalendarExample02 {
	...
	public static void main(String[] args) {
		...
		//month의 경우 0부터 시작하기 대문에 8월인 경우, 7로 지정해야한다. 
		//date1.set(2015, Calendar.AUGUST, 15); 와 같이 할 수도 있다.
		date1.set(2015, 7,15); //2015년 8월 15일로 날짜를 설정한다.(임의로 날짜를 정함) --> 이건 8월 15일을 의미 month는 0~11
		...
		//1일 = 24*60*60
		System.out.println("일(day)로 계산하면 " + difference/(20*60*60)+"일입니다.");
	}
